...
enum class IVA(val dataInci: String, val General: Double, val Reduit: Double, val SuperReduit: Double, val Excempt: Double = 0.0){
    IVA1986("1986-01-01", 0.12,0.6, 0.0,0.0),
    IVA1992("1992-01-01", 0.15,0.6, 0.0,0.0),
    IVA1993("1993-01-01", 0.15,0.6, 0.3,0.0),
    IVA1995("1995-01-01", 0.16,0.7, 0.4,0.0),
    IVA2010("2010-01-01", 0.18,0.8, 0.4,0.0),
    IVA2012("2012-07-15", 0.21,0.10, 0.4,0.0)
}
